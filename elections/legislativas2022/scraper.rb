...
class Legislativas2022 < ElectionScraper::Base
  ELECTION_URL = 'https://www.legislativas2022.mai.gov.pt/resultados/territorio-nacional'
  OUTPUT_FILE = File.join(__dir__, 'data', 'legislativas2022.csv')
